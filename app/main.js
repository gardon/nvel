...
var _user$project$Models$SiteInformation = F6(
	function (a, b, c, d, e, f) {
...
var _user$project$Msgs$UpdateSiteInfo = function (a) {
	return {ctor: 'UpdateSiteInfo', _0: a};
};
var _user$project$Msgs$ChapterContentLoad = function (a) {
	return {ctor: 'ChapterContentLoad', _0: a};
};
var _user$project$Msgs$ChaptersLoad = function (a) {
...
var _user$project$Chapters$getChapterContent = F2(
	function (model, chapter) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			model.backendConfig.backendURL,
			A2(
				_elm_lang$core$Basics_ops['++'],
		...
		return A2(
			...
			A2(_elm_lang$http$Http$get, url, _user$project$Chapters$chapterDecoder));
	});
var _user$project$Chapters$getChapters = function (model) {
	var url = A2(_elm_lang$core$Basics_ops['++'], model.backendConfig.backendURL, _user$project$Models$chapterListEndpoint);
	return A2(
		_elm_lang$http$Http$send,
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$for('mce-EMAIL'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(text_message),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-describedby', 'mailchimp-small'),
																			_1: {ctor: '[]'}
																		}
																	}
																}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(button_text),
																_1: {
																	ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('mailchimp-small'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(small_message),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$View$viewTitle = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(model.siteInformation.title),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$View$viewChapterNavItem = function (chapter) {
	var chapterText = A2(
		_elm_lang$core$Basics_ops['++'],
		'#',
	...
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_0: {
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							'url(',
							A2(_elm_lang$core$Basics_ops['++'], chapter.featured_image.uri, ')'))
					},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(chapterText),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$span,
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], ': ', chapter.title)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$viewChapterNavigation = F3(
	function (previous, current, next) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('chapter-navigation'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('previous'),
						_1: {ctor: '[]'}
					},
					A2(_elm_lang$core$List$map, _user$project$View$viewChapterNavItem, previous)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$ul,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('current'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _user$project$View$viewChapterNavItem(current),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(_elm_lang$core$List$map, _user$project$View$viewChapterNavItem, next)),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$View$viewSocialIcon = function (social) {
	var svgpath = function () {
		var _p0 = social;
		switch (_p0.ctor) {
			case 'FacebookIcon':
				return 'M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z';
			case 'InstagramIcon':
			...
			default:
				return 'M20 4.364v-4.364h-4.364l-.435.439-2.179 4.124-.647.437h-7.375v6h4.103l.359.404-4.462 8.232v4.364h4.509l.435-.439 2.174-4.124.648-.437h7.234v-6h-3.938l-.359-.438z';
		}
	}();
	return A2(
		_elm_lang$svg$Svg$svg,
...
var _user$project$View$viewDeviantArtLink = function (handle) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewSocialIcon(_user$project$Models$DeviantArtIcon),
			_1: {
				ctor: '::',
...
var _user$project$View$viewInstagramLink = function (handle) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewSocialIcon(_user$project$Models$InstagramIcon),
			_1: {
				ctor: '::',
...
var _user$project$View$viewFacebookPageLink = function (handle) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewSocialIcon(_user$project$Models$FacebookIcon),
			_1: {
				ctor: '::',
...
var _user$project$View$viewSocialLinks = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$core$Native_Utils.eq(model.siteInformation.facebook_page, '') ? _elm_lang$html$Html$text('') : A2(
				_elm_lang$html$Html$li,
				{
					ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Native_Utils.eq(model.siteInformation.instagram_handle, '') ? _elm_lang$html$Html$text('') : A2(
					_elm_lang$html$Html$li,
					{
						ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(model.siteInformation.deviantart_profile, '') ? _elm_lang$html$Html$text('') : A2(
						_elm_lang$html$Html$li,
						{
							ctor: '::',
...
var _user$project$View$templatePages = F2(
	function (model, content) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			{
...
var _user$project$View$viewChapterNavbar = F2(
	function (model, chapter) {
		var chapterNavigation = function () {
		...
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('index-icon'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('/chapters'),
							_1: {
								ctor: '::',
								_0: _user$project$View_Attributes$onLinkClick(
									_user$project$Msgs$ChangeLocation('/chapters')),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _user$project$View$viewIndexIcon,
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('share-icon'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
	...
	return A2(
		...
		_user$project$Skeleton$skeletonGridSize(_user$project$Skeleton$SixColumns),
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fb-page'),
					_1: {
						ctor: '::',
						_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$cite('https://www.facebook.com/abismos.oficial/'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fb-xfbml-parse-ignore'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://www.facebook.com/abismos.oficial/'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Chapters_Chapter$viewChapterContent = function (model) {
	return A2(_elm_lang$core$List$map, _user$project$Chapters_Chapter$viewSection, model);
};
var _user$project$Chapters_Chapter$viewChapter = function (chapter) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
...
var _user$project$Config_Environment$backend = {backendURL: 'http://localhost:8080/'};
...
var _user$project$Routing$routeContent = function (model) {
	...
	switch (_p0.ctor) {
		...
		case 'ChapterRoute':
			...
			return A3(_user$project$View$templateChapter, model, chapter, content);
		case 'AboutRoute':
			var content = {
				ctor: '::',
				_0: _user$project$View$viewAbout(model),
				_1: {ctor: '[]'}
			};
			return A2(_user$project$View$templatePages, model, content);
		default:
...
var _user$project$Main$toggleNavbar = function (flag) {
	return _elm_lang$core$Native_Utils.eq(flag, true) ? _user$project$Msgs$Navbar(_user$project$Models$Show) : _user$project$Msgs$Navbar(_user$project$Models$Hide);
};
var _user$project$Main$view = function (model) {
	var content = _user$project$Routing$routeContent(model);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		content);
